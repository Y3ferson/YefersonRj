...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!-- css files -->
    <link href="{{ asset('portal/css/bootstrap.css') }}" rel='stylesheet' type='text/css' /><!-- bootstrap css -->
    <link href="{{ asset ('portal/css/style.css') }}" rel='stylesheet' type='text/css' /><!-- custom css -->
    <link href="{{ asset ('portal/css/fontawesome-all.css') }}" rel="stylesheet"><!-- fontawesome css -->
	<!-- //css files -->
...
<!-- copyright -->
	...
	<script src="portal/js/smoothscroll.js"></script><!-- Smooth scrolling -->
